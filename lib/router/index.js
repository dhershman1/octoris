...
const { first, last, pipeP, reduce, type, update } = require('kyanite')
...
/**
 * Writes headers onto the response before sending
 * @param {Object} response The Octoris Response object
 */
function writeHead (response) {
  return (header, value) => {
    Object.assign(response.headers, { [header]: value })
